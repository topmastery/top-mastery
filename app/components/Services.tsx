...
const ServiceCard = memo(({ 
  ...
  return (
    <motion.div
      ...
      className={`group bg-dark-light p-8 rounded-xl hover:bg-gradient-to-br ${service.gradient} transition-all duration-300 relative overflow-hidden`}
    >
      ...
      <div className="relative z-10">
        ...
        <button 
          ...
          className="flex items-center gap-2 text-primary hover:gap-4 transition-all duration-300 font-semibold group"
        >
